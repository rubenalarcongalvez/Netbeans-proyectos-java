...
public class Pg248_Final721_Conjunto {
    ...
    public static void main(String[] args) {
		...
		System.out.println("¿Está el conjunto 1 incluido en el conjunto 2? " + Conjunto.incluido(c1, c2));
		
		System.out.print("Insertamos solo los comunes entre c1 y c2 en c3: ");
		Conjunto c3 = Conjunto.interseccion(c1, c2);
		c3.mostrar();
		
		System.out.print("Insertamos solo los NO comunes en c2 que no estén en c1 en c4: ");
