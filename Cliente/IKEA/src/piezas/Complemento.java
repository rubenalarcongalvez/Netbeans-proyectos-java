 ...
 */
public class Complemento extends Pieza {
	private String material;

	public Complemento(String material, String codigo, String nombre, String descripcion, String dimensiones, double precio, int stock) {
