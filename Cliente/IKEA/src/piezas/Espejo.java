 ...
 */
public class Espejo extends Pieza {
	private String material;

	public Espejo(String material, String codigo, String nombre, String descripcion, String dimensiones, double precio, int stock) {
