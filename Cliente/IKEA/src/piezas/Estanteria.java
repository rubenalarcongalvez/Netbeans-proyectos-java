 ...
 */
public class Estanteria extends Pieza {
	private String material;
	private String color;

	public Estanteria(String material, String color, String codigo, String nombre, String descripcion, String dimensiones, double precio, int stock) {
