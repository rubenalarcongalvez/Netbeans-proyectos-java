 ...
 */
public class validacionFormularioEquivalenciaBasicaTest {

	public validacionFormularioEquivalenciaBasicaTest() {
	}
	...
	public void testValidacionFormularioCorrecto() throws Exception {
		...
		validacionFormulario form = new validacionFormulario ("erkapitan72","a123456", "07/04/1972", 40);

		String resultadoEsperado = "Registro completado de forma correcta";

		String sRespuesta = form.validacionRegistro();
	...
	public void testValidacionFormularioLongitud() throws Exception {
		...
		validacionFormulario form = new validacionFormulario ("erka","a123456", "07/04/1972", 40);
	...
	public void testValidacionFormularioPrimerCaracter() throws Exception {
		...
		validacionFormulario form = new validacionFormulario ("72erkapitan","a123456", "07/04/1972", 40);
	...
	public void testValidacionFormularioLongitudContrasena() throws Exception {
		...
		validacionFormulario form = new validacionFormulario ("erkapitan72","a1234567890", "07/04/1972", 40);
	...
	public void testValidacionFormularioFormatoContrasena() throws Exception {
		...
		validacionFormulario form = new validacionFormulario ("erkapitan72","a.123456", "07/04/1972", 40);
	...
	public void testValidacionFormularioEdad() throws Exception {
		...
		validacionFormulario form = new validacionFormulario ("erkapitan72","a123456", "07/04/2015", 40);
	...
	public void testValidacionFormularioSaldo() throws Exception {
		...
		validacionFormulario instance = new validacionFormulario ("erkapitan72","a123456", "07/04/1972", 60);
